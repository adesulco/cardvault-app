...
- Name: v22-deployment-readiness.spec.ts >> V22 Deployment Readiness >> Google OAuth shows error message on failure
- Location: tests/e2e/v22-deployment-readiness.spec.ts:5:7
...
Locator: [data-testid="auth-error"], .error-message, [role="alert"], text="Google Sign-in failed" >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "[data-testid="auth-error"], .error-message, [role="alert"], text="Google Sign-in failed"". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for [data-testid="auth-error"], .error-message, [role="alert"], text="Google Sign-in failed" >> nth=0
...
- generic [active] [ref=e1]:
  - main [ref=e3]:
    - generic [ref=e5]:
      ...
      - paragraph [ref=e11]: Sign in to your CardVault account
      - button "Continue with Google" [ref=e12]:
        - img [ref=e13]
        - text: Continue with Google
      - generic [ref=e20]: or email
      - generic [ref=e22]: Google Sign-in failed. Please try again or use email login.
      - generic [ref=e23]:
        - generic [ref=e24]:
          - img [ref=e25]
