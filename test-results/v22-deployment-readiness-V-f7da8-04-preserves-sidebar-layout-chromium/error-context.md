...
- Name: v22-deployment-readiness.spec.ts >> V22 Deployment Readiness >> Admin 404 preserves sidebar layout
- Location: tests/e2e/v22-deployment-readiness.spec.ts:17:7
...
Locator: locator('nav, [role="navigation"], aside').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('nav, [role="navigation"], aside').first()
